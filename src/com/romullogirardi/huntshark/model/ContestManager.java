...
//		computeLastContest(new Contest(1518, new GregorianCalendar(2015, 0, 3), "POSSE-GO", numbers1, reward20points, reward19points, reward18points, reward17points, reward16points, reward0points), true);
//		int[] numbers2 = {3, 6, 13, 19, 32, 37, 42, 44, 45, 50, 51, 56, 64, 69, 70, 73, 75, 82, 84, 99};
//		computeLastContest(new Contest(1519, new GregorianCalendar(2015, 0, 7), "SANTA FÉ DO SUL-SP", numbers2, reward20points, reward19points, reward18points, reward17points, reward16points, reward0points), true);
